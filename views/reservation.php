<html>
      ...
      <body>
        <center>
          <div>
            <h1>Reservation</h1>
            <progress id="avancement" value="0" max="100"></progress><br>
            Le prix de la place est de 10 euros jusqu'à douze ans et ensuite de
              15 euros.<br>Le prix de l'assurance annulation est de 20 euros quel
                que soit le nombre de voyageurs.<br>
              ...
              <table>
                  ...
                  <tr>
                    ...
                    <td><input type='checkbox' name='insurance'
                      <?php if (isset($reservation))
                            echo $reservation->getCheckbox() ?>/><br>
                    </td>
                  </tr>
                </table>
