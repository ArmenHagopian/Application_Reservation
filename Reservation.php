      ...
      <body>
        <center>
          ...
          <form method='Post' action='Buttons.php'>
            <table>
                <tr>
                  <td>Destination<br><?php if (isset($reservation) && $reservation->getDestinationError() == 'true') echo '<error>*Veuillez entrer une destination</error>'?></td>
                ...
                <tr>
                  <td>Nombre de places<br><?php if (isset($reservation) && $reservation->getNbr_placesError() == 'true') echo '<error>*Veuillez entrer le nombre de places</error>'?></td>
