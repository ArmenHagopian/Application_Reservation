        ...
        <center>
          ...
          <form method='Post' action='Buttons.php'>
            <table>
                <tr>
                  <td>Destination<br>
                    <?php if (isset($reservation) && $reservation->getDestinationError() == 'true') echo '<error>*Veuillez entrer une destination</error>'?></td>
                ...
                <tr>
                  <td>Nombre de places<br>
                    <?php if (isset($reservation) && $reservation->getNbr_placesError() == 'true' && (!is_numeric($reservation->getNbr_places()) || $reservation->getNbr_places() < 1 || $reservation->getNbr_places() > 10)) echo '<error>*Veuillez entrer un nombre <br> supérieur à 0 et inférieur à 10</error>'?></td>
